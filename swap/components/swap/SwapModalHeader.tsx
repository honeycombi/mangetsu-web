...
import { EventName, SWAP_PRICE_UPDATE_USER_RESPONSE } from 'swap/analytics/constants'
import { formatPercentInBasisPointsNumber } from 'swap/analytics/utils'
...
const ArrowWrapper = styled.div<{ redesignFlag: boolean }>`
  ...
  background-color: ${({ theme, redesignFlag }) =>
    redesignFlag ? theme.backgroundSurface : theme.deprecated_bg1};
  border: 4px solid;
  border-color: ${({ theme, redesignFlag }) =>
    redesignFlag ? theme.backgroundModule : theme.deprecated_bg0};
  z-index: 2;
`
  ...
  return (
    <AutoColumn gap={'4px'} style={{ marginTop: '1rem' }}>
      ...
      <ArrowWrapper redesignFlag={redesignFlagEnabled}>
        <ArrowDown
          size="16"
          color={redesignFlagEnabled ? theme.textPrimary : theme.deprecated_text2}
        />
      </ArrowWrapper>
