import { ChainTokenMap, tokensToChainTokenMap } from 'swap/lib/hooks/useTokenList/utils'
import { useMemo } from 'react'
import { useAppSelector } from 'swap/state/hooks'
import sortByListPriority from 'swap/utils/listSort'
